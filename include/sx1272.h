...
#define RADIO_SAFETY_TIME                          10 // [ms]
//TODO for both 1st and 2nd receiving windows
/*!
 * Radio complete Wake-up Time with margin for temperature compensation
 */
#define RADIO_WAKEUP_TIME                           ( RADIO_OSC_STARTUP + RADIO_SLEEP_TO_RX + RADIO_SAFETY_TIME)
...
void SX1272Reset( void ); //added 20/02
